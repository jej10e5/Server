...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  private static final String TF_OD_API_MODEL_FILE = "detecdongju.tflite";
  private static final String TF_OD_API_LABELS_FILE = "file:///android_asset/labelmapz.txt";
  ...
  protected void processImage() {
    ...
    sendBitmapThroughNetwork(cropCopyBitmap);
                  ...
                  public void run() {
                    ...
                    for (final Classifier.Recognition result : results) {
                      ...
                      if (location != null && result.getConfidence() >= minimumConfidence) {
                        ...
                        Button btn2=(Button) findViewById(R.id.btngo);
  ...
  public void gogogo(){
    new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Button btn3 = (Button) findViewById(R.id.btnBluetoothOff);
      }
    };
  }
